  ...
  return (
    <div className="w-full bg-[#F9F8F4]">
      <div className="mx-auto max-w-[1200px] px-6 pb-16 pt-8 w-full">
        <Link href="/" className="inline-flex items-center text-[13px] font-bold text-gray-500 hover:text-[#FF5722] mb-6 transition-colors uppercase tracking-wider">
        ...
        <div className="flex flex-col xl:flex-row gap-8 lg:gap-10 items-start">
          ...
          <div className="flex-1 w-full">
            <article className="rounded-[1.5rem] border border-gray-100 bg-white shadow-sm overflow-hidden">
              
              {/* Thumbnail Banner */}
              <div className="w-full h-64 md:h-80 lg:h-[400px] relative bg-gray-100">
              ...
              <div className="p-8 md:p-10 lg:p-12">
                <header className="mb-10">
                  <div className="flex items-center gap-4 text-xs text-gray-500 mb-6 font-bold uppercase tracking-widest">
                  ...
                  <h1 className="text-3xl md:text-[42px] font-extrabold text-gray-900 tracking-tight leading-[1.2]">
                    {log.title}
                  </h1>
                </header>

                <div className="text-gray-700 leading-loose text-[15px] md:text-[17px] whitespace-pre-wrap font-medium">
                  {log.content}
                </div>
              </div>
            </article>
